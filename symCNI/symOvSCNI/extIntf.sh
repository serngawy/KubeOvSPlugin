...
# Example of adding external intf and bridge
...
sudo ovs-ofctl add-flow br-ext "table=0, priority=10, tcp, nw_dst=192.168.40.12 actions=output:prt-int"
sudo ovs-ofctl add-flow br-ext "table=0, priority=10, udp, nw_dst=192.168.40.12 actions=output:prt-int"